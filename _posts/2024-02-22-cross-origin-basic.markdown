---
layout: post
title: "cross-origin resource sharing (cors) & cách fix"
date: 2024-02-22 19:29:39 +0700
categories: [Software Development]
tags: [frontend, software-development, vietnamese, web]
---
...
Website của bạn đang ở domain `tungdadev.com`. Thì không có cách nào bạn gửi request ajax sang domain `tungdadev.he` hay `tungdadev.she` được. Vì nó khác `orgin`
...
- **Access-Control-Allow-zOrigin**: Những `origin` mà server cho phép. (ví dụ server `tungdadev.his` chỉ chấp nhận `tungdadev.com` request lên)
