---
layout: post
title: "Factory Method Pattern trong Java"
date: 2024-08-28 19:29:39 +0700
...
### 2. Nhược điểm
- **_Tăng độ phức tạp_**: Khi thêm `Factory Method`, số lượng lớp và interface có thể tăng, khiến cấu trúc hệ thống trở nên phức tạp hơn.

- **_Có thể gây dư thừa_**: Trong các trường hợp đơn giản, việc sử dụng `Factory Method` có thể không cần thiết, dẫn đến dư thừa không đáng có.
...
### 3. Khi nào nên dùng Factory Method
...
#### Sử dụng Factory Method trong Client:
```java
// Main.java
public class Main {
