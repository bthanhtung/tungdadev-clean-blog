...
![keycloak-system]({{ site.baseurl }}/assets/img/blog/keycloak-system.png)
...
![credentials-flow]({{ site.baseurl }}/assets/img/blog/credentials-flow.png)
...
![token-lifecycle]({{ site.baseurl }}/assets/img/blog/token-lifecycle.png)
...
![token-refresh]({{ site.baseurl }}/assets/img/blog/token-refresh.png)
